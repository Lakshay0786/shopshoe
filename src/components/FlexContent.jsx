...
const FlexContent = ({ ifExists, endpoint: {
  title, subtitle, heading, text, img, url, btn
} }) => {
  return (
    <>
      ...
      `}>
        <div className='max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center'>
          ...
          <h1 className='text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-900 fiter drop-shadow-lg'>{title}</h1>
