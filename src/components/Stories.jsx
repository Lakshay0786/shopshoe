              ...
              <SplideSlide key={i} className='mb-0.5' >
                <div className='relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200'>
                  <div className='flex items-center justify-center'>
                    <img src={val.img} alt={`img/story/${i}`} className='w-full h-auto object-cover shadow-md shadow-slate-200 rounded-tl-lg rounded-tr-lg' /></div>
                  <div className='flex items-center justify-between w-full px-4'>
                    ...
                    <div className='flex items-center gap-0.5'>
                      ...
                      <span className='text-xs text-bold'>{val.time}</span>
                    </div>
                  ...
                  <div className='flex items-center justify-center px-4 w-full '>
                    <a href={val.url} role={'button'} target='_black' className='w-full bg-gradient-to-b from-slate-900 to-black shadow-md shadow-black text-center text-slate-100 py-1.5 button-theme'>{val.btn}</a>
                  </div>
                </div>
              </SplideSlide>
            ))}
